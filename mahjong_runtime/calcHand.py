...
from mahjong_runtime.utils import tiles_to_mahjong_array_strings
...
def analyze_hand(
    ...
    **kwargs
    ...
    # 手牌（アガリ牌含）
    extra_win = [] if win in tiles else [win]
    hand14 = tiles_to_mahjong_array_strings(tiles, extra_win, need_aka=True)
